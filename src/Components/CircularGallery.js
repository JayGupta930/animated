...
class App {
  constructor(container, { items, bend, textColor = "#ffffff", borderRadius = 0, font = "bold 30px DM Sans" } = {}) {
    ...
    this.scroll = { ease: 0.2, current: 0, target: 0, last: 0 }  // reduced from 0.02 to 0.015
  ...
  onTouchMove(e) {
    ...
    const distance = (this.start - x) * 0.01  // reduced from 0.02 to 0.01
  ...
  onWheel() {
    this.scroll.target += 0.05  // reduced from 0.1 to 0.05
